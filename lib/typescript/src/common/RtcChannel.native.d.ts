...
import type { ChannelMediaOptions, ChannelMediaRelayConfiguration, ClientRoleOptions, DataStreamConfig, EncryptionConfig, LiveInjectStreamConfig, LiveTranscoding } from './Classes';
import type { ClientRole, ConnectionStateType, EncryptionMode, UserPriority, VideoStreamType } from './Enums';
import type { RtcChannelEvents, Subscription } from './RtcEvents';
/**
...
export default class RtcChannel implements RtcChannelInterface {
     ...
     * @param listener The [`RtcChannelEvents`]{@link RtcChannelEvents} handler.
     */
    removeListener<EventType extends keyof RtcChannelEvents>(event: EventType, listener: RtcChannelEvents[EventType], subscription?: EmitterSubscription): void;
    /**
 ...
 * @ignore
 */
interface RtcChannelInterface extends RtcAudioInterface, RtcVideoInterface, RtcVoicePositionInterface, RtcPublishStreamInterface, RtcMediaRelayInterface, RtcDualStreamInterface, RtcFallbackInterface, RtcMediaMetadataInterface, RtcEncryptionInterface, RtcInjectStreamInterface, RtcStreamMessageInterface {
    destroy(): Promise<void>;
    setClientRole(role: ClientRole, options?: ClientRoleOptions): Promise<void>;
    joinChannel(token: string | undefined | null, optionalInfo: string | undefined | null, optionalUid: number, options: ChannelMediaOptions): Promise<void>;
    joinChannelWithUserAccount(token: string | undefined | null, userAccount: string, options: ChannelMediaOptions): Promise<void>;
