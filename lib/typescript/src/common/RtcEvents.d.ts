import type { AudioFileInfo, AudioVolumeInfo, FacePositionInfo, LastmileProbeResult, LocalAudioStats, LocalVideoStats, RecorderInfo, Rect, RemoteAudioStats, RemoteVideoStats, RtcStats, UserInfo, WlAccStats } from './Classes';
import type { AudioFileInfoError, AudioLocalError, AudioLocalState, AudioMixingReason, AudioMixingStateCode, AudioOutputRouting, AudioRemoteState, AudioRemoteStateReason, ChannelMediaRelayError, ChannelMediaRelayEvent, ChannelMediaRelayState, ClientRole, ConnectionChangedReason, ConnectionStateType, ErrorCode, InjectStreamStatus, LocalVideoStreamError, LocalVideoStreamState, NetworkQuality, NetworkType, RtmpStreamingErrorCode, RtmpStreamingEvent, RtmpStreamingState, StreamPublishState, StreamSubscribeState, SuperResolutionStateReason, UploadErrorReason, UserOfflineReason, VideoRemoteState, VideoRemoteStateReason, VirtualBackgroundSourceStateReason, WarningCode, ContentInspectResult, ProxyType, WlAccAction, WlAccReason, ClientRoleChangeFailedReason } from './Enums';
/**
 * @internal
 * @ignore
 */
...
export declare type WarningCallback = 
/**
 ...
 */
(err: ErrorCode) => void;
export declare type ApiCallCallback = 
/**
...
export declare type UidWithElapsedAndChannelCallback = 
/**
...
export declare type RtcStatsCallback = 
/**
 * @param stats Statistics of the call.
 */
(stats: RtcStats) => void;
export declare type UserAccountCallback = 
/**
 * @param uid The ID of the local user.
 * @param userAccount The user account of the local user.
 */
(uid: number, userAccount: string) => void;
export declare type UserInfoCallback = 
/**
...
export declare type ClientRoleCallback = 
/**
...
export declare type UidWithElapsedCallback = 
/**
...
export declare type UserOfflineCallback = 
/**
 * @param uid ID of the user or host who leaves the channel or goes offline.
 * @param reason Reason why the user goes offline.
 */
(uid: number, reason: UserOfflineReason) => void;
export declare type ConnectionStateCallback = 
/**
...
export declare type NetworkTypeCallback = 
/**
 * @param type The network type.
 */
(type: NetworkType) => void;
export declare type TokenCallback = 
/**
 * @param token The token that will expire in 30 seconds.
 */
(token: string) => void;
export declare type AudioVolumeCallback = 
/**
...
export declare type UidWithMutedCallback = 
/**
...
export declare type VideoSizeCallback = 
/**
...
export declare type RemoteVideoStateCallback = 
/**
...
export declare type LocalVideoStateCallback = 
/**
...
export declare type RemoteAudioStateCallback = 
/**
...
export declare type LocalAudioStateCallback = 
/**
...
export declare type FallbackCallback = 
/**
...
export declare type FallbackWithUidCallback = 
/**
...
export declare type NetworkQualityWithUidCallback = 
/**
...
export declare type StreamInjectedStatusCallback = 
/**
...
export declare type StreamMessageCallback = 
/**
...
export declare type StreamMessageErrorCallback = 
/**
 * @param uid User ID of the remote user sending the data stream.
 * @param streamId Stream ID.
...
export declare type UidWithEnabledCallback = 
/**
...
export declare type EnabledCallback = 
/**
...
export declare type AudioQualityCallback = 
/**
...
export declare type MetadataCallback = 
/**
...
export declare type FacePositionCallback = 
/**
...
export declare type StreamPublishStateCallback = 
/**
...
export declare type StreamSubscribeStateCallback = 
/**
 * @param channel The channel name.
 ...
 * @param elapseSinceLastState The time elapsed (ms) from the previous state to the current state.
 */
(channel: string, uid: number, oldState: StreamSubscribeState, newState: StreamSubscribeState, elapseSinceLastState: number) => void;
export declare type RtmpStreamingEventCallback = 
/**
 * @param url The RTMP or RTMPS streaming URL.
...
export declare type UserSuperResolutionEnabledCallback = 
/**
...
export declare type UploadLogResultCallback = 
/**
 * @ignore
 *
...
export declare type VirtualBackgroundSourceEnabledCallback = 
/**
...
export declare type RequestAudioFileInfoCallback = 
/**
...
export declare type SnapshotTakenCallback = 
/**
 * @param channel The channel name.
...
export declare type ProxyConnectedCallback = 
/**
 * @param channel The channel name.
...
export declare type ClientRoleChangeCallback = 
/**
 * @ignore For future use
 */
(reason: ClientRoleChangeFailedReason, currentRole: ClientRole) => void;
export declare type RecorderStateChangedCallback = 
/**
