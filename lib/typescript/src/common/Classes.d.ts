import type { AreaCode, AudienceLatencyLevelType, AudioChannel, AudioCodecProfileType, AudioRecordingPosition, AudioRecordingQuality, AudioSampleRateType, CameraCaptureOutputPreference, CameraDirection, CaptureBrightnessLevelType, DegradationPreference, EncryptionMode, ExperiencePoorReason, ExperienceQualityType, LastmileProbeResultState, LighteningContrastLevel, LogLevel, NetworkQuality, VideoCodecProfileType, VideoCodecType, VideoFrameRate, VideoMirrorMode, VideoOutputOrientationMode, VideoQualityAdaptIndication, VideoStreamType, VirtualBackgroundBlurDegree, VirtualBackgroundSourceType, VideoCodecTypeForStream } from './Enums';
/**
 ...
 */
export declare class AgoraImage {
    /**
...
export declare class LiveTranscoding {
    ...
    constructor(transcodingUsers: TranscodingUser[], params?: {
        width?: number;
        height?: number;
        videoBitrate?: number;
        videoFramerate?: VideoFrameRate;
...
export declare class ChannelMediaInfo {
     ...
     */
    uid: number;
    constructor(channelName: string, uid: number, params?: {
        token?: string;
    });
}
/**
 ...
 */
export declare class LiveInjectStreamConfig {
    /**
 ...
 * @since v3.4.2
 */
export declare class RhythmPlayerConfig {
    /**
...
export declare class RtcEngineContext {
    ...
    deepARWidth?: number;
    deepARHeight?: number;
    constructor(appId: string, params?: {
        areaCode?: AreaCode[];
        logConfig?: LogConfig;
    }, deepARKey?: string, deepARWidth?: number, deepARHeight?: number);
}
/**
 *
 * Configurations for the [`RtcEngine`]{@link RtcEngine}.
 ...
 * @since v3.3.1
 */
export declare class RtcEngineConfig extends RtcEngineContext {
}
/**
...
export declare class AudioRecordingConfiguration {
    ...
    constructor(filePath: string, params?: {
        recordingQuality?: AudioRecordingQuality;
        recordingPosition?: AudioRecordingPosition;
        recordingSampleRate?: AudioSampleRateType;
        recordingChannel?: number;
...
export declare class MediaRecorderConfiguration {
    ...
    constructor(storagePath: string, containerFormat: number, streamType: number, maxDurationMs: number, recorderInfoUpdateInterval: number);
}
/**
