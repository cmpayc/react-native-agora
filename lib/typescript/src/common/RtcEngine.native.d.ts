...
import { AudioRecordingConfiguration, BeautyOptions, CameraCapturerConfiguration, ChannelMediaOptions, ChannelMediaRelayConfiguration, ClientRoleOptions, ColorEnhanceOptions, ContentInspectConfig, DataStreamConfig, EchoTestConfiguration, EncryptionConfig, LastmileProbeConfig, LiveInjectStreamConfig, LiveTranscoding, LowLightEnhanceOptions, MediaRecorderConfiguration, RhythmPlayerConfig, RtcEngineConfig, RtcEngineContext, UserInfo, VideoDenoiserOptions, VideoEncoderConfiguration, VirtualBackgroundSource, WatermarkOptions } from './Classes';
import type { AreaCode, AudioEffectPreset, AudioEqualizationBandFrequency, AudioProfile, AudioRecordingQuality, AudioReverbPreset, AudioReverbType, AudioSampleRateType, AudioScenario, AudioSessionOperationRestriction, AudioVoiceChanger, ChannelProfile, ClientRole, CloudProxyType, ConnectionStateType, EncryptionMode, LogFilter, StreamFallbackOptions, UserPriority, VideoStreamType, VoiceBeautifierPreset, VoiceConversionPreset, AudioMixingDualMonoMode } from './Enums';
import type { RtcEngineEvents, Subscription } from './RtcEvents';
/**
 * @ignore
 */
declare type Rate = 1 | 2 | 3 | 4 | 5;
/**
...
export default class RtcEngine implements RtcEngineInterface {
     ...
     *
     */
    static getErrorDescription(error: number): Promise<string>;
    /**
     ...
     *   - 101(InvalidAppId): The app ID is invalid. Check if it is in the correct format.
     */
    static createWithAreaCode(appId: string, areaCode: AreaCode): Promise<RtcEngine>;
    /**
     * Creates an [`RtcEngine`]{@link RtcEngine} instance.
     *
     ...
     *   - 101(InvalidAppId): The app ID is invalid. Check if it is in the correct format.
     */
    static createWithConfig(config: RtcEngineConfig): Promise<RtcEngine>;
    /**
     * Creates an [`RtcEngine`]{@link RtcEngine} instance.
     *
     * @since v3.4.5
     ...
     *   - 101(InvalidAppId): The app ID is invalid. Check if it is in the correct format.
     */
    static createWithContext(context: RtcEngineContext): Promise<RtcEngine>;
    /**
     ...
     * @param listener The [`RtcEngineEvents`]{@link RtcEngineEvents} handler.
     */
    removeListener<EventType extends keyof RtcEngineEvents>(event: EventType, listener: RtcEngineEvents[EventType], subscription?: EmitterSubscription): void;
    /**
     ...
     */
    startAudioMixing(filePath: string, loopback: boolean, replace: boolean, cycle: number, startPos?: number): Promise<void>;
    /**
     ...
     */
    playEffect(soundId: number, filePath: string, loopCount: number, pitch: number, pan: number, gain: number, publish: Boolean, startPos?: number): Promise<void>;
    /**
     ...
     */
    startEchoTest(intervalInSeconds?: number, config?: EchoTestConfiguration): Promise<void>;
    /**
     ...
     */
    startAudioRecordingWithConfig(config: AudioRecordingConfiguration): Promise<void>;
    /**
     ...
     *
     */
    enableVirtualBackground(enabled: boolean, backgroundSource: VirtualBackgroundSource): Promise<void>;
    /**
     ...
     */
    enableContentInspect(enabled: boolean, config: ContentInspectConfig): Promise<void>;
    /**
     * @ignore For future user
     */
     ...
     *
     */
    setColorEnhanceOptions(enabled: boolean, options: ColorEnhanceOptions): Promise<void>;
    /**
     ...
     */
    setLowLightEnhanceOptions(enabled: boolean, options: LowLightEnhanceOptions): Promise<void>;
    /**
     ...
     *
     */
    setVideoDenoiserOptions(enabled: boolean, options: VideoDenoiserOptions): Promise<void>;
    /**
     ...
     * - Void if the method call succeeds.
     */
    switchDeepArEffect(name: string, slot: string): Promise<void>;
}
/**
 * @ignore
 */
interface RtcEngineInterface extends RtcUserInfoInterface, RtcAudioInterface, RtcVideoInterface, RtcAudioMixingInterface, RtcAudioEffectInterface, RtcVoiceChangerInterface, RtcVoicePositionInterface, RtcPublishStreamInterface, RtcMediaRelayInterface, RtcAudioRouteInterface, RtcEarMonitoringInterface, RtcDualStreamInterface, RtcFallbackInterface, RtcTestInterface, RtcMediaMetadataInterface, RtcWatermarkInterface, RtcEncryptionInterface, RtcAudioRecorderInterface, RtcInjectStreamInterface, RtcCameraInterface, RtcStreamMessageInterface, RtcMediaRecorderInterface {
    destroy(): Promise<void>;
    setChannelProfile(profile: ChannelProfile): Promise<void>;
    setClientRole(role: ClientRole, options?: ClientRoleOptions): Promise<void>;
    joinChannel(token: string | undefined | null, channelName: string, optionalInfo: string | undefined | null, optionalUid: number, options?: ChannelMediaOptions): Promise<void>;
...
interface RtcUserInfoInterface {
    registerLocalUserAccount(appId: string, userAccount: string): Promise<void>;
    joinChannelWithUserAccount(token: string, channelName: string, userAccount: string, options?: ChannelMediaOptions): Promise<void>;
    getUserInfoByUserAccount(userAccount: string): Promise<UserInfo>;
    getUserInfoByUid(uid: number): Promise<UserInfo>;
}
/**
