 ...
 * @ignore
 */
const RtcChannelEvent = new _reactNative.NativeEventEmitter(AgoraRtcChannelModule);
...
class RtcChannel {
  ...
  _callMethod(method, args) {
    return AgoraRtcChannelModule.callMethod(method, args === undefined ? {
  ...
  static async create(channelId) {
    ...
    await AgoraRtcChannelModule.callMethod('create', {
      channelId
    });
  ...
  setAVSyncSource(channelId, uid) {
    return this._callMethod('setAVSyncSource', {
      channelId,
      uid
    });
  }
  ...
  startRtmpStreamWithoutTranscoding(url) {
    return this._callMethod('startRtmpStreamWithoutTranscoding', {
      url
    });
  }
   ...
   */
  stopRtmpStream(url) {
    return this._callMethod('stopRtmpStream', {
      url
    });
  }
  ...
  updateRtmpTranscoding(transcoding) {
    return this._callMethod('updateRtmpTranscoding', {
      transcoding
    });
  }
}
