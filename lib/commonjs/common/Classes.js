...
class RtcEngineContext {
  ...
  constructor(appId, params, deepARKey, deepARWidth, deepARHeight) {
    _defineProperty(this, "appId", void 0);
    _defineProperty(this, "areaCode", void 0);
    _defineProperty(this, "logConfig", void 0);
    _defineProperty(this, "deepARKey", void 0);
    _defineProperty(this, "deepARWidth", void 0);
    _defineProperty(this, "deepARHeight", void 0);
    this.appId = appId;
    if (params) {
    ...
    if (deepARKey) {
      this.deepARKey = deepARKey;
    }
    if (deepARWidth) {
      this.deepARWidth = deepARWidth;
    }
    if (deepARHeight) {
      this.deepARHeight = deepARHeight;
    }
  }
}
